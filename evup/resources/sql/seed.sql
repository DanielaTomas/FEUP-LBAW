...
-- Event --
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 13, 'Jerde Inc', false, '519 Arapahoe Parkway', 'Unspecified parasitic disease', 'http://dummyimage.com/103x100.png/5fa2dd/ffffff', '2022-12-19', '2023-02-13');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 2, 'Kovacek-Conn', false, '16 Brentwood Park', 'Nondisplaced fracture of base of neck of left femur', 'http://dummyimage.com/214x100.png/dddddd/000000', '2023-11-08', '2023-11-30');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 13, 'Wilkinson-Klein', false, '21812 Ohio Alley', 'Benign neoplasm of scrotum', 'http://dummyimage.com/136x100.png/dddddd/000000', '2023-02-06', '2023-02-16');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 17, 'McDermott, Hammes and Medhurst', true, '52 Onsgard Trail', 'Other injury of superior mesenteric artery', 'http://dummyimage.com/109x100.png/dddddd/000000', '2023-01-03', '2023-01-31');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 18, 'Marquardt and Sons', false, '0752 Mayfield Park', 'Nondisplaced fracture of distal phalanx of right ring finger, sequela', 'http://dummyimage.com/134x100.png/cc0000/ffffff', '2023-01-24', '2023-01-25');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 20, 'Rutherford, DuBuque and MacGyver', false, '3926 Montana Avenue', 'Person boarding or alighting a three-wheeled motor vehicle injured in collision with two- or three-wheeled motor vehicle', 'http://dummyimage.com/175x100.png/ff4444/ffffff', '2023-01-03', '2023-02-15');
...
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 30, 'Stiedemann, Heidenreich and Bradtke', false, '73 Miller Terrace', 'Other specified and unspecified injuries of neck', 'http://dummyimage.com/205x100.png/cc0000/ffffff', '2023-01-19', '2023-01-24');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 2, 'Lesch Inc', false, '94086 Vahlen Avenue', 'Breakdown (mechanical) of surgically created arteriovenous fistula, subsequent encounter', 'http://dummyimage.com/222x100.png/ff4444/ffffff', '2023-01-02', '2023-01-03');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 17, 'Haag, Reinger and Hegmann', true, '61 Forest Park', 'Periprosthetic osteolysis of internal prosthetic right knee joint, sequela', 'http://dummyimage.com/211x100.png/5fa2dd/ffffff', '2022-11-29', '2023-01-01');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 18, 'Reynolds, Mertz and Adams', false, '18331 Bonner Alley', 'Other superficial bite of right upper arm, initial encounter', 'http://dummyimage.com/248x100.png/ff4444/ffffff', '2022-12-08', '2022-12-09');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 20, 'Bauch, Mitchell and Mraz', true, '583 Heffernan Junction', 'Ataxia following unspecified cerebrovascular disease', 'http://dummyimage.com/221x100.png/dddddd/000000', '2023-02-26', '2023-02-27');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 21, 'Leannon and Sons', true, '4626 Claremont Junction', 'Type AB blood, Rh positive', 'http://dummyimage.com/219x100.png/ff4444/ffffff', '2023-01-27', '2023-01-30');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 22, 'Lebsack, Hickle and Kassulke', false, '689 Debs Point', 'Other cyst of bone, left hand', 'http://dummyimage.com/234x100.png/5fa2dd/ffffff', '2022-12-23', '2022-12-25');
...
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 30, 'Lehner-Yundt', false, '765 Prairie Rose Hill', 'Maternal care for other malpresentation of fetus', 'http://dummyimage.com/179x100.png/dddddd/000000', '2022-12-29', '2023-01-27');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 2, 'Bauch-Pagac', true, '6762 Mallard Point', 'Laceration of unspecified urinary and pelvic organ, sequela', 'http://dummyimage.com/114x100.png/cc0000/ffffff', '2023-01-04', '2023-01-30');
...
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 18, 'Kreiger-Leuschke', true, '7163 Maryland Park', 'Laceration of other blood vessels of thorax, left side, initial encounter', 'http://dummyimage.com/217x100.png/dddddd/000000', '2023-02-08', '2023-02-17');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 20, 'Schneider and Sons', true, '498 Miller Trail', 'Pedestrian injured in unspecified nontraffic accident', 'http://dummyimage.com/243x100.png/ff4444/ffffff', '2022-11-21', '2022-11-29');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 21, 'Pollich LLC', false, '280 Banding Parkway', 'Activities involving personal hygiene and interior property and clothing maintenance', 'http://dummyimage.com/186x100.png/ff4444/ffffff', '2023-10-25', '2023-10-30');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 22, 'Brown LLC', true, '3548 Crest Line Plaza', 'Adverse effect of predominantly alpha-adrenoreceptor agonists', 'http://dummyimage.com/198x100.png/dddddd/000000', '2022-12-02', '2022-12-16');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 28, 'Hermiston and Sons', true, '06 Summerview Lane', 'Sepsis due to Methicillin resistant Staphylococcus aureus', 'http://dummyimage.com/168x100.png/5fa2dd/ffffff', '2023-01-17', '2023-01-18');
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 30, 'Ratke-Conn', true, '5 Dovetail Park', 'Person boarding or alighting from bus injured in collision with fixed or stationary object', 'http://dummyimage.com/160x100.png/cc0000/ffffff', '2023-11-17', '2023-12-06');
...
insert into Event ( userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 13, 'Sauer, Gerlach and Kiehn', true, '002 Lindbergh Center', 'Asphyxiation due to plastic bag, accidental, sequela', 'http://dummyimage.com/212x100.png/ff4444/ffffff', '2023-12-01', '2023-12-15');
...
insert into Event ( eventId, userId, eventname, public, address, description, eventPhoto, startDate, endDate) values ( 31, 3, 'Christmas Party', true, '001 North Pole', 'Christmas Party in Santa house. Everyone can join!', 'http://dummyimage.com/212x100.png/ff4444/ffffff', '2022-12-24', '2022-12-25');
