<div id="eventCard{{ $event->eventid }}"
    ...
    <div class="w-full h-64 bg-top bg-cover rounded-t flex flex-col justify-between"
        ...
        <a href="{{route('manage_event', ['id' => $event->eventid])}}" title="Manage Event" class="self-center text-white m-4 right-2.5 bottom-2.5 bg-gray-900 hover:bg-indigo-600 transition ease-in-out duration-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-gray-600 dark:hover:bg-gray-700">
