<nav class="flex justify-between bg-gray-900 text-white w-screen">
    ...
    @auth
        ...
        <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="inline-flex items-center text-sm font-medium text-center text-white hover:text-indigo-300 transition ease-in-out focus:outline-none dark:hover:text-white dark:text-gray-400" type="button"> 
