<form method="POST" action="{{ route('createEvent') }}" enctype="multipart/form-data" class="flex-1">
    @csrf
    <div class="mb-6">
    ...
    <div class="flex items-start mb-6 mt-6">
        <div class="flex items-center h-5">
            <input id="private" type="checkbox" name="private" {{ old('private') ? 'checked' : '' }} class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800">
        </div>
