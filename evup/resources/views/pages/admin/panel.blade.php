...
<div class="py-5 container">
    <div class="d-flex flex-row row w-100 m-0">
        ...
        <a href="{{ url('/admin/users') }}" class="text-secondary col-12 col-lg-4 my-3 adminPanelCard">
        ...
        <a class="text-secondary col-12 col-lg-4 my-3 adminPanelCard" href="{{ url('/admin/organizer_requests') }}">
            <div class="d-flex flex-column manageContainer border bg-light h-100">
                ...
                <div class="manageLink">
                    <h3>Manage Organizer Requests</h3>
                </div>
            </div>
        </a>
    </div>
