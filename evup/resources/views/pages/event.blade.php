            ...
            <section class="flex flex-col  p-6 max-w-xl grow">
                ...
                <section>
                    <div class=" mx-auto ">
                        ...
                        ?>
                            <div class="flex  items-center justify-center  mb-4 p-6 rounded-lg bg-gray-200 ">
                                @if (!$event->eventcanceled)
                                <div class="flex flex-wrap -mx-3 " >
                                    <h2 class="px-4 pb-2 text-gray-800 text-lg font-bold">Leave a comment</h2>
                                    ...
                                    <div class="w-full px-3 sm:w-1/2">
                                        <div class="mb-5">
                                            ...
                                            <input class="rounded-lg" type="file" id="commentFileInput" >
                                        </div>
                                    </div>
