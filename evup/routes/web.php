...
Route::get('forgot_password', 'Auth\PasswordResetController@showSendLinkForm')->name('forgot_password');
Route::post('forgot_password', 'Auth\PasswordResetController@sendLink')->name('send_link');
